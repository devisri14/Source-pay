...
public class Scenario_17 extends TestExecutor {
	...
	@Test(enabled = true)
	public static void Scenario_17() {
		dataUtils.setSheetName("Scenario_17");
        try {
            ...
            while (i <= dataUtils.noOfRows()) {
                  ...
                  if (getData("RunThis").toLowerCase().equals("yes")) {
                        logger = report.startTest("Scenario 17");
...
//PO_02 - Enter Requisition - non-catalog
            			...
            			babyfunction.clickbyxpath(PO2.Description, "Click on Description", "NIL");
            			driver.findElement(By.xpath(PO2.Description)).clear();
            			babyfunction.inputbyxpath(PO2.Description, "Entering Description", getData("PO2_Line3_Description").trim());
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO2.CategoryName, "CategoryName", "");
            			babyfunction.clickbyxpath(PO2.CategoryName, "Click on CategoryName", "NIL");
            			driver.findElement(By.xpath(PO2.CategoryName)).clear();
            			babyfunction.inputbyxpath(PO2.CategoryName, "Entering CategoryName", getData("PO2_Line3_Category").trim());
            			babyfunction.clickbyxpath(PO2.Suggestion, " Selected Category", "");
            			Thread.sleep(2000);
            			...
            			babyfunction.clickbyxpath(PO2.Supplier, "Click on Supplier", "NIL");
            			driver.findElement(By.xpath(PO2.Supplier)).clear();
            			babyfunction.inputbyxpath(PO2.Supplier, "Entering Supplier", getData("PO2_Line3_Supplier").trim());
            			babyfunction.clickbyxpath(PO2.Suggestion, " Selected Supplier", "");
            			Thread.sleep(2000);
            			...
            			babyfunction.clickbyxpath(PO2.Quantity, "Click on Quantity", "NIL");
            			driver.findElement(By.xpath(PO2.Quantity)).clear();
            			babyfunction.inputbyxpath(PO2.Quantity, "Entering Quantity", getData("PO2_Line3_Quantity").trim());
            			Thread.sleep(2000);

            			babyfunction.ObjectXpathavailable(PO2.UOM, "UOM", "");
            			babyfunction.clickbyxpath(PO2.UOM, "Click on UOM", "NIL");
            			driver.findElement(By.xpath(PO2.UOM)).clear();
            			babyfunction.inputbyxpath(PO2.UOM, "Entering UOM", getData("PO2_Line3_UOM").trim());
            			babyfunction.clickbyxpath(PO2.Suggestion, "Seleceted UOM", "");
            			Thread.sleep(2000);
            			...
            			babyfunction.clickbyxpath(PO2.Price, "Click on Price", "NIL");
            			driver.findElement(By.xpath(PO2.Price)).clear();
            			babyfunction.inputbyxpath(PO2.Price, "Entering Price", getData("PO2_Line3_Price").trim());
            			Thread.sleep(2000);
            		...
            		//	driver.findElement(By.cssSelector("body")).sendKeys(Keys.CONTROL + "w");
            			...
            			babyfunction.ObjectXpathavailable("//a[contains(text(),'Requisition "+ReqNo[1]+"')]", "Purchase Order Number", "");
            			babyfunction.clickbyxpath("//a[contains(text(),'Requisition "+ReqNo[1]+"')]", "Clicking on Purchase Order Number", "");
            			Thread.sleep(5000);
 ...
 // PO_09 - Process Requisition - create PO
			...
			// PO6 - Modify Requisition
            			...
            			babyfunction.ObjectXpathavailable(ap01.Action1, "Action button", "");
            			babyfunction.clickbyxpath(ap01.Action1, "Action ", "");
            			Thread.sleep(2000);

            			babyfunction.ObjectXpathavailable(PO11.EditOrder1, "Edit button", "");
            			babyfunction.clickbyxpath(PO11.EditOrder1, "Edit ", "");
            			Thread.sleep(2000);

          				babyfunction.ObjectXpathavailable(PO11.Yes, "OK button", "");
          				babyfunction.clickbyxpath(PO11.Yes, "Clicking on OkBtn ", "");
           				Thread.sleep(2000);
            			...
            			babyfunction.ObjectXpathavailable(PO11.PriceLine1, "Price", "");
            			babyfunction.clickbyxpath(PO11.PriceLine1, "Price", "");
            			driver.findElement(By.xpath(PO11.PriceLine1)).clear();
            			Thread.sleep(1000);
            			babyfunction.inputbyxpath(PO11.PriceLine1, "Price", getData("PO_6_Line1_Price").trim());
            			Thread.sleep(2000);
            			...
            			babyfunction.ObjectXpathavailable(PO11.QuantityLine3, "Quantity", "");
            			babyfunction.clickbyxpath(PO11.QuantityLine3, "Quantity", "");
            			driver.findElement(By.xpath(PO11.QuantityLine3)).clear();
            			Thread.sleep(1000);
            			babyfunction.inputbyxpath(PO11.QuantityLine3, "Quantity", getData("PO_6_Line3_qty").trim());
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO11.PriceLine3, "Price", "");
            			babyfunction.clickbyxpath(PO11.PriceLine3, "Price", "");
            			driver.findElement(By.xpath(PO11.PriceLine3)).clear();
            			Thread.sleep(1000);
            			babyfunction.inputbyxpath(PO11.PriceLine3, "Price", getData("PO_6_Line3_Price").trim());
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO11.Description, "Description", "");
            			babyfunction.clickbyxpath(PO11.Description, "Description", "");
            			Thread.sleep(1000);
            			babyfunction.inputbyxpath(PO11.Description, "Price", getData("PO2_Line1_Description").trim());
            			Thread.sleep(3000);
            			...
            			babyfunction.ObjectXpathavailable(PO11.PopUPok, "OK", "");
            			babyfunction.clickbyxpath(PO11.PopUPok, "OK", "");
            			Thread.sleep(3000);
            			
            			
            			// Approval
            			
            			babyfunction.ObjectXpathavailable(navigation.Home, "Home", "");
            			babyfunction.clickbyxpath(navigation.Home, "Home", "");
            			Thread.sleep(3000);
            			...
            			PO13.switchToNewWindow(1);
            			babyfunction.ObjectXpathavailable("//a[contains(text(),'(Purchase Order) "+PONumberLine1[1]+"') and contains(text(),'Change Submitted')]", "Purchase Order Number", "");
            			babyfunction.clickbyxpath("//a[contains(text(),'(Purchase Order) "+PONumberLine1[1]+"') and contains(text(),'Change Submitted')]", "Clicking on Purchase Order Number", "");
            			Thread.sleep(5000);
...
// PO_14 - Receive Purchase Order
            		...
            		//  Lines 3
            			...
            			babyfunction.ObjectXpathavailable("(//input[@class='xyt' and @type='checkbox'])[4]//following::input[1]", "Quantity", "");
            			babyfunction.clickbyxpath("(//input[@class='xyt' and @type='checkbox'])[4]//following::input[1]", "Clicking on Quantity", "");
            			driver.findElement(By.xpath("(//input[@class='xyt' and @type='checkbox'])[4]//following::input[1]")).clear();
            			babyfunction.inputbyxpath("(//input[@class='xyt' and @type='checkbox'])[4]//following::input[1]", "Entering Quantity", getData("AP-01_Line3_Match").trim());
            			Thread.sleep(2000);
