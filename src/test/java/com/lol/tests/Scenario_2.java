...
public class Scenario_2 extends TestExecutor {
	...
	@Test(enabled = true)
	public static void Scenario_02_Goods_Multiple_Suppliers() {
		dataUtils.setSheetName("Scenario_2");
        try {
            ...
            while (i <= dataUtils.noOfRows()) {
                  ...
                  if (getData("RunThis").toLowerCase().equals("yes")) {
                        logger = report.startTest("Scenario_02_Goods_Multiple_Suppliers");
                        logger.log(LogStatus.INFO, "=======Start Execution Report========");
                        
                        
           // PO_35 - Create Shopping List
                        

            			PO1.navigation();
            			//Line 1
            			
            			//Create Shopping List - non-Catalog					
            			babyfunction.ObjectXpathavailable(PO2.NonCatalogRequest, "NonCatalogRequest", "");
            			babyfunction.clickbyxpath(PO2.NonCatalogRequest, "Click on NonCatalogRequest", "");
            			Thread.sleep(3000);
            			
            			babyfunction.ObjectXpathavailable(PO2.Description, "Description", "");
            			babyfunction.clickbyxpath(PO2.Description, "Click on Description", "");
            			driver.findElement(By.xpath(PO2.Description)).clear();
            			babyfunction.inputbyxpath(PO2.Description, "Entering Description", getData("PO35_Line1_Description").trim());
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO2.CategoryName, "CategoryName", "");
            			babyfunction.clickbyxpath(PO2.CategoryName, "Click on CategoryName", "");
            			driver.findElement(By.xpath(PO2.CategoryName)).clear();
            			babyfunction.inputbyxpath(PO2.CategoryName, "Entering CategoryName",getData("PO35_Line1_Category").trim());
            			babyfunction.clickbyxpath(PO2.Suggestion, "", "");
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO2.Quantity, "Quantity", "");
            			babyfunction.clickbyxpath(PO2.Quantity, "Click on Quantity", "");
            			driver.findElement(By.xpath(PO2.Quantity)).clear();
            			babyfunction.inputbyxpath(PO2.Quantity, "Entering Quantity", getData("PO35_Line1_Quantity").trim() );
            			Thread.sleep(2000);

            			babyfunction.ObjectXpathavailable(PO2.UOM, "UOM", "");
            			babyfunction.clickbyxpath(PO2.UOM, "Click on UOM", "");
            			driver.findElement(By.xpath(PO2.UOM)).clear();
            			babyfunction.inputbyxpath(PO2.UOM, "Entering UOM", getData("PO35_Line1_UOM").trim());
            			babyfunction.clickbyxpath(PO2.Suggestion, "", "");
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO2.Price, "Price", "");
            			babyfunction.clickbyxpath(PO2.Price, "Click on Price", "");
            			driver.findElement(By.xpath(PO2.Price)).clear();
            			babyfunction.inputbyxpath(PO2.Price, "Entering Price", getData("PO35_Line1_Price").trim());
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO2.Supplier, "Supplier", "");
            			babyfunction.clickbyxpath(PO2.Supplier, "Click on Supplier", "");
            			driver.findElement(By.xpath(PO2.Price)).clear();
            			babyfunction.inputbyxpath(PO2.Supplier, "Entering Supplier", getData("PO35_Line1_Supplier").trim());
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO35.AddToMyShoppingList, "AddToMyShoppingList", "");
            			babyfunction.clickbyxpath(PO35.AddToMyShoppingList, "Click on AddToMyShoppingList", "");
            			Thread.sleep(2000);
            			
            			java.util.List<WebElement> ShopList = driver.findElements(By.xpath(PO35.ShoppingList));
            			System.out.println("List size = "+ShopList.size());
            			
            			if(ShopList.size()>1){
            				
            				babyfunction.ObjectXpathavailable(PO35.ShopList1, "ShopList", "");
            				babyfunction.clickbyxpath(PO35.ShopList1, "Click on first list", "");
            				Thread.sleep(2000);
            				
            				babyfunction.ObjectXpathavailable(PO9.DocumentOKBtn, "Ok Button", "");
            				babyfunction.clickbyxpath(PO9.DocumentOKBtn, "Click on ok button", "");
            				Thread.sleep(2000);
            				
            			}else{
            				
            				babyfunction.ObjectXpathavailable(PO35.CreateNew, "CreateNewList", "");
            				babyfunction.clickbyxpath(PO35.CreateNew, "Click on CreateNewList", "");
            				Thread.sleep(2000);
            				
            				babyfunction.ObjectXpathavailable(PO35.ShoppingListName, "ShoppingListName", "");
            				babyfunction.clickbyxpath(PO35.ShoppingListName, "Click on ShoppingListName", "");
            				babyfunction.inputbyxpath(PO35.ShoppingListName, "Entering ShoppingListName", "List1");
            				Thread.sleep(2000);
            				
            				babyfunction.ObjectXpathavailable(PO9.OkButton, "Ok Button", "");
            				babyfunction.clickbyxpath(PO9.OkButton, "Click on ok button", "");
            				Thread.sleep(2000);
            			}
            			
            			babyfunction.ObjectXpathavailable(PO1.ReturnToShopping, "ReturnToShopping", "");
            			babyfunction.clickbyxpath(PO1.ReturnToShopping, "Click on ReturnToShopping", "");
            			Thread.sleep(2000);
...
//Line 2
            			...
            			babyfunction.clickbyxpath(PO2.Description, "Click on Description", "");
            			driver.findElement(By.xpath(PO2.Description)).clear();
            			babyfunction.inputbyxpath(PO2.Description, "Entering Description", "Creative Services");
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO2.CategoryName, "CategoryName", "");
            			babyfunction.clickbyxpath(PO2.CategoryName, "Click on CategoryName", "");
            			driver.findElement(By.xpath(PO2.CategoryName)).clear();
            			babyfunction.inputbyxpath(PO2.CategoryName, "Entering CategoryName",getData("PO35_Line2_Category").trim());
            			babyfunction.clickbyxpath(PO2.Suggestion, "", "");
            			Thread.sleep(2000);
            			...
            			babyfunction.clickbyxpath(PO2.Quantity, "Click on Quantity", "");
            			driver.findElement(By.xpath(PO2.Quantity)).clear();
            			babyfunction.inputbyxpath(PO2.Quantity, "Entering Quantity", getData("PO35_Line2_Quantity").trim() );
            			Thread.sleep(2000);

            			babyfunction.ObjectXpathavailable(PO2.UOM, "UOM", "");
            			babyfunction.clickbyxpath(PO2.UOM, "Click on UOM", "");
            			driver.findElement(By.xpath(PO2.UOM)).clear();
            			babyfunction.inputbyxpath(PO2.UOM, "Entering UOM", getData("PO35_Line2_UOM").trim());
            			babyfunction.clickbyxpath(PO2.Suggestion, "", "");
            			Thread.sleep(2000);
            			...
            			babyfunction.clickbyxpath(PO2.Price, "Click on Price", "");
            			driver.findElement(By.xpath(PO2.Price)).clear();
            			babyfunction.inputbyxpath(PO2.Price, "Entering Price", "300");
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO2.Supplier, "Supplier", "");
            			babyfunction.clickbyxpath(PO2.Supplier, "Click on Supplier", "");
            			driver.findElement(By.xpath(PO2.Price)).clear();
            			babyfunction.inputbyxpath(PO2.Supplier, "Entering Supplier", getData("PO35_Line2_Supplier").trim());
            			Thread.sleep(2000);
            			...
            			java.util.List<WebElement> ShopList1 = driver.findElements(By.xpath(PO35.ShoppingList));
            			System.out.println("List size = "+ShopList1.size());
            			...
            			if(ShopList1.size()>1){
            				...
            				babyfunction.ObjectXpathavailable(PO35.ShoppingListName, "ShoppingListName", "");
            				babyfunction.clickbyxpath(PO35.ShoppingListName, "Click on ShoppingListName", "");
            				babyfunction.inputbyxpath(PO35.ShoppingListName, "Entering ShoppingListName", "List2");
            				Thread.sleep(2000);
...
// PO_02 - Enter Requisition - non-catalog
            			...
            			babyfunction.ObjectXpathavailable(PO35.Shopping_List, " Shopping List", "");
        				babyfunction.clickbyxpath(PO35.Shopping_List, "Click Shopping List", "");
        				Thread.sleep(2000);
            			 
        				
            			driver.findElement(By.xpath(PO1.Quantity)).clear();
            			babyfunction.inputbyxpath(PO1.Quantity, "Entering Quantity", "10000");
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO1.Add_To_Requisition, "Add To Requisition", "");
        				babyfunction.clickbyxpath(PO1.Add_To_Requisition, "Click on Add To Requisition", "");
        				Thread.sleep(2000);
            			
            			driver.findElement(By.xpath(PO1.Quantity2)).clear();
            			babyfunction.inputbyxpath(PO1.Quantity2, "Entering Quantity", "5");
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(PO1.Add_To_Requisition2, "Add To Requisition", "");
        				babyfunction.clickbyxpath(PO1.Add_To_Requisition2, "Click on Add To Requisition", "");
        				Thread.sleep(2000);
    					...
    					Thread.sleep(2000);
    					babyfunction.inputbyxpath(PO1.DeliverToLocation, "Entering deliver to location", getData("PO2_Line1_Location").trim());
    					...
    					Thread.sleep(1000);
    					babyfunction.inputbyxpath(PO1.ChargeAccount, "Entering Charge amount ","200.02.2000.179200000.000");
...
// PO_14 - Receive Purchase Order
            			...
            			babyfunction.inputbyxpath(ap01.invoice_amount, "Entering Amount", getData("AP-05_Line1_Invoice Amount").trim());
            			Thread.sleep(2000);
            			...
            			babyfunction.inputbyxpath(ap01.Quantity, "Entering Quantity", getData("AP-05_Line1_Match").trim());
            			Thread.sleep(2000);
            			...
            			Thread.sleep(1000);
            			babyfunction.clickbyxpath(ap01.Actions, "Click on Action drop down", "Nil");
            			Thread.sleep(1000);
            			...
            			String SystemHoldValidation1 = driver.findElement(By.xpath(ap01.SystemHolds)).getText();
            			System.out.println("System Hold = "+SystemHoldValidation1);
            			String Validation1 = driver.findElement(By.xpath("//span[text()='Validation']//following::span[1]")).getText();
            			System.out.println("Validation Status = "+Validation1);
            			
            			if(SystemHoldValidation1.equalsIgnoreCase("0") || Validation1.equalsIgnoreCase("Validated")){
