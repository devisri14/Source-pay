...
public class Scenario_74 extends TestExecutor{
	...
	@Test(enabled = true)
	public static void Scenario_74() {
		dataUtils.setSheetName("Scenario_74");
        try {
            ...
            while (i <= dataUtils.noOfRows()) {
                  ...
                  if (getData("RunThis").toLowerCase().equals("yes")) {
                        logger = report.startTest("Scenario 74");
...
// AP_41 - 2Way Invoice match to PO
            			...
            			babyfunction.ObjectXpathavailable(ap01.Quantity, "Amount", "");
            			babyfunction.clickbyxpath(ap01.Quantity, "Clicking on Amount", "");
            			driver.findElement(By.xpath(ap01.Quantity)).clear();
            			babyfunction.inputbyxpath(ap01.Quantity, "Entering Amount", getData("AP-41_Line1_Invoice Amount").trim());
            			Thread.sleep(2000);
