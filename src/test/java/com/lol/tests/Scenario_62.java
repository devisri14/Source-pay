...
public class Scenario_62 extends TestExecutor {
	...
	public static void Scenario_01_Goods_Multiple_Suppliers() {
		dataUtils.setSheetName("Scenario_62");
		try {
			...
			while (i <= dataUtils.noOfRows()) {
				...
				if (getData("RunThis").toLowerCase().equals("yes")) {
					logger = report.startTest("Scenario 62");
					...
					babyfunction.inputbyxpath(PO2.Description, "Entering Description",
							getData("PO41_Line1_Description").trim());
					Thread.sleep(2000);
					...
					babyfunction.inputbyxpath(PO2.CategoryName, "Entering CategoryName",
							getData("PO41_Line1_Category").trim());
					...
					babyfunction.inputbyxpath(PO1.DeliverToLocation, "Entering deliver to location",
							getData("PO41_Line1_Location").trim());
					Thread.sleep(1000);
					...
					Thread.sleep(2000);
					babyfunction.inputbyxpath(PO1.ChargeAccount, "Entering Charge Account ",
							getData("PO41_Line1_ChargeAccount").trim());
					Thread.sleep(2000);

					babyfunction.ObjectXpathavailable(".//span[text()='LEGACY SUBLEDGER']/following::input[4]",
							"LegacySubLedger ", "");
					babyfunction.clickbyxpath(".//span[text()='LEGACY SUBLEDGER']/following::input[4]",
							"clicking on LegacySubLedger", "");
					Thread.sleep(2000);
					driver.findElement(By.xpath(".//span[text()='LEGACY SUBLEDGER']/following::input[4]")).clear();
					Thread.sleep(1000);

					babyfunction.inputbyxpath(".//span[text()='LEGACY SUBLEDGER']/following::input[4]",
							"LegacySubLedger ", "10");
					Thread.sleep(1000);
					...
					Thread.sleep(2000);
					String[] PONumberLine1 = PurchaseNumberLine2.split("(?<=\\D)(?=\\d)|(?<=\\d)(?=\\D)");
					...
					babyfunction.inputbyxpath(ap01.invoice_amount, "Entering Amount",
							getData("AP-46_Line1_Invoice Amount").trim());
					Thread.sleep(2000);
					...
					babyfunction.inputbyxpath(ap01.Quantity, "Entering Quantity", getData("AP-46_Line1_Match").trim());
					Thread.sleep(2000);
					...
					babyfunction.ObjectXpathavailable(ap01.MatchLineAdd, "Add Line", "");
					babyfunction.clickbyxpath(ap01.MatchLineAdd, "Add Line", "");
					Thread.sleep(2000);

					babyfunction.ObjectXpathavailable(ap01.Type, "Type", "");
					babyfunction.clickbyxpath(ap01.Type, "Type", "");
					Thread.sleep(2000);

					babyfunction.ObjectXpathavailable(ap01.Freight, "Freight", "");
					babyfunction.clickbyxpath(ap01.Freight, "Freight", "");
					Thread.sleep(2000);

					babyfunction.ObjectXpathavailable(ap01.AddAmount, "AddAmount", "");
					babyfunction.clickbyxpath(ap01.AddAmount, "AddAmount", "");
					driver.findElement(By.xpath(ap01.AddAmount)).clear();
					babyfunction.inputbyxpath(ap01.AddAmount, "Entering Quantity",
							getData("AP-46_Line1_Add frieght").trim());
					Thread.sleep(2000);
					...
					Thread.sleep(2000);
					babyfunction.inputbyxpath(AP05.RateName, "Entering Rate Name", "LOLUSE_MN_PINEISLAND");
					Thread.sleep(2000);
					
					babyfunction.ObjectXpathavailable(AP05.TaxAmount, " TaxAmount", "");
					babyfunction.clickbyxpath(AP05.TaxAmount, "Clicking RateName", "");
					driver.findElement(By.xpath(AP05.TaxAmount)).clear();
					Thread.sleep(2000);
					babyfunction.inputbyxpath(AP05.TaxAmount, "TaxAmount", getData("AP-46_Line1_Calculate  tax").trim());
					Thread.sleep(2000);
