...
public class Scenario_66 extends TestExecutor{
	...
	public static void Scenario_01_Goods_Multiple_Suppliers() {
		dataUtils.setSheetName("Scenario_66");
        try {
            ...
            while (i <= dataUtils.noOfRows()) {
                  ...
                  if (getData("RunThis").toLowerCase().equals("yes")) {
                        logger = report.startTest("Scenario 66");
    					...
    					Thread.sleep(2000);
    					babyfunction.inputbyxpath(PO1.ChargeAccount, "Entering Charge Account ",getData("PO41_Line1_ChargeAccount").trim());
    					Thread.sleep(2000);
            			...
            			babyfunction.inputbyxpath(ap01.invoice_amount, "Entering Amount", getData("AP-47_Line1_Invoice Amount").trim());
            			Thread.sleep(2000);
            			...
            			babyfunction.inputbyxpath(ap01.Quantity, "Entering Quantity", getData("AP-47_Line1_Invoice Amount").trim());
            			Thread.sleep(2000);
            			...
            			babyfunction.ObjectXpathavailable(ap01.manage_invoice, "Manage Invoice", "NIL");
            			babyfunction.clickbyxpath(ap01.manage_invoice, "Manage Invoice", "NIL");
            			Thread.sleep(5000);
            			
            			babyfunction.ObjectXpathavailable(ap01.InvoiceNumber, "InvoiceNumber", "NIL");
            			babyfunction.clickbyxpath(ap01.InvoiceNumber, "InvoiceNumber", "NIL");
            			driver.findElement(By.xpath(ap01.InvoiceNumber)).clear();
            			Thread.sleep(1000);
            			babyfunction.inputbyxpath(ap01.InvoiceNumber, "InvoiceNumber", InvoiceNumber_1_AP05);
            			Thread.sleep(2000);
            		
            			babyfunction.ObjectXpathavailable(ap01.invoiceSearch, "Invoice Search", "NIL");
            			babyfunction.clickbyxpath(ap01.invoiceSearch, "Invoice Search", "NIL");
            			Thread.sleep(5000);

            			babyfunction.ObjectXpathavailable("//a[text()='"+InvoiceNumber_1_AP05+"']", "Invoice Search", "NIL");
            			babyfunction.clickbyxpath("//a[text()='"+InvoiceNumber_1_AP05+"']", "Invoice Search", "NIL");
            			Thread.sleep(2000);
            			
            			String PaidStatus= driver.findElement(By.xpath("//*[text()='Paid']//following::span[1]")).getText();
            			logger.log(LogStatus.PASS, "Paid status is "+PaidStatus);
            			
            			babyfunction.ObjectXpathavailable(ap01.Actions, "Action", "NIL");
            			babyfunction.clickbyxpath(ap01.Actions, "Actions", "NIL");
            			Thread.sleep(2000);
            			
            			babyfunction.ObjectXpathavailable(ap01.invoiceCancel, "Cancel Invoice", "NIL");
            			babyfunction.clickbyxpath(ap01.invoiceCancel, "Cancel Invoice", "NIL");
            			Thread.sleep(2000);
            			...
            			String ValidationStatus= driver.findElement(By.xpath("//*[text()='Validation']//following::span[1]")).getText();
            			logger.log(LogStatus.PASS, "PaValidation status is "+ValidationStatus);
