...
public class Scenario_9 extends TestExecutor {
	...
	@Test(enabled = true)
	public static void Scenario_09() {
		dataUtils.setSheetName("Scenario_9");
        try {
            ...
            while (i <= dataUtils.noOfRows()) {
                  ...
                  if (getData("RunThis").toLowerCase().equals("yes")) {
                        logger = report.startTest("Scenario 9");
...
// AP_06
            			...
            			babyfunction.inputbyxpath(ap01.invoice_amount, "Entering Amount", getData("AP-06_Line1_Invoice Amount"));
            			Thread.sleep(2000);
            			...
            			babyfunction.inputbyxpath(ap01.Quantity, "Entering Quantity", getData("AP-06_Line1_Match"));
            			Thread.sleep(2000);
...
// AP_06
            			...
            			babyfunction.ObjectXpathavailable(ap01.invoice_number, "Invoice NUmber", "");
            			babyfunction.clickbyxpath(ap01.invoice_number, "Clicking on Invoice number", "NIL");
            			String InvoiceNumber_3_AP06 = "1-Team1-"+babyfunction.GetRandomNumber();
            			babyfunction.inputbyxpath(ap01.invoice_number, "Entering Supplier name", InvoiceNumber_3_AP06);
            			System.out.println("Invoice Number Line 1 = "+InvoiceNumber_3_AP06);
            			Thread.sleep(2000);
