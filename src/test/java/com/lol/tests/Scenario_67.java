...
public class Scenario_67 extends TestExecutor{
	...
	public static void Scenario_01_Goods_Multiple_Suppliers() {
		dataUtils.setSheetName("Scenario_67");
        try {
            ...
            while (i <= dataUtils.noOfRows()) {
                  ...
                  if (getData("RunThis").toLowerCase().equals("yes")) {
                        logger = report.startTest("Scenario 67");
...
// PO41 - Enter Requisition - Service non-catalog 2-way
    					...
    					Thread.sleep(2000);
    					babyfunction.inputbyxpath(PO1.ChargeAccount, "Entering Charge Account ",getData("PO41_Line1_ChargeAccount_").trim());
    					Thread.sleep(2000);
...
// PO6 - Modify Requisition
            			...
            			babyfunction.ObjectXpathavailable(PO11.Price, "Price", "");
            			babyfunction.clickbyxpath(PO11.Price, "Price", "");
            			driver.findElement(By.xpath(PO11.Price)).clear();
            			Thread.sleep(1000);
            			babyfunction.inputbyxpath(PO11.Price, "Price", getData("PO6_Line1_Amount").trim());
            			Thread.sleep(2000);

            			babyfunction.ObjectXpathavailable(PO11.Description, "Description", "");
            			babyfunction.clickbyxpath(PO11.Description, "Description", "");
            			Thread.sleep(1000);
            			babyfunction.inputbyxpath(PO11.Description, "Price", getData("PO41_Line1_Description"
            					+ "").trim());
            			Thread.sleep(3000);
...
// AP_41 - 2Way Invoice match to PO
