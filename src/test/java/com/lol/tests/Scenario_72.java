...
public class Scenario_72 extends TestExecutor {
	...
	public static void Scenario_01_Goods_Multiple_Suppliers() {
		dataUtils.setSheetName("Scenario_72");
        try {
            ...
            while (i <= dataUtils.noOfRows()) {
                  ...
                  if (getData("RunThis").toLowerCase().equals("yes")) {
                        logger = report.startTest("Scenario 72");
...
// PO - 12 Cancel Purchase Order
            			...
            			PO11.ManageAndSearchOrder(PONumberLine1[1]);
