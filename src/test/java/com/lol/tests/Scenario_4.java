...
public class Scenario_4 extends TestExecutor {
	...
	@Test(enabled = true)
	public static void Scenario_04() {
		dataUtils.setSheetName("Scenario_4");
        try {
            ...
            while (i <= dataUtils.noOfRows()) {
                  ...
                  if (getData("RunThis").toLowerCase().equals("yes")) {
                        logger = report.startTest("Scenario 04");
...
//PO_02 - Enter Requisition - non-catalog
  ...
  // PO_09 - Process Requisition - create PO
    					...
    					babyfunction.clickbyxpath(PO9.DocumentOKBtn, "DocumentOKBtn", "");
    					Thread.sleep(3000);
    					
    					babyfunction.ObjectXpathavailable(PO1.RowClick, "RowClick", "");
    					babyfunction.clickbyxpath(PO1.RowClick, "RowClick", "");
    					Thread.sleep(2000);
    					...
    					babyfunction.clickbyxpath(PO9.Create, "Create", "");
    					Thread.sleep(3000);

    					babyfunction.ObjectXpathavailable("(//button[@_afrpdo='cancel'])[1]", "OKBtn", "");
    					//driver.findElement(By.xpath("(//button[@_afrpdo='cancel'])[1]")).click();
    					babyfunction.clickbyxpath("(//button[@_afrpdo='cancel'])[1]", "OKBtn", "");
    					Thread.sleep(3000);

    					babyfunction.ObjectXpathavailable(PO1.Submit, "Submit", "");
    					babyfunction.clickbyxpath(PO1.Submit, "Submit button", "");
    					Thread.sleep(3000);
...
// PO_14 - Receive Purchase Order
            			...
            			babyfunction.inputbyxpath(ap01.invoice_amount, "Entering Amount", getData("AP-06_Line1_Invoice Amount").trim());
            			Thread.sleep(2000);
            			...
            			babyfunction.inputbyxpath(ap01.Quantity, "Entering Quantity", getData("AP-06_Line1_Match").trim());
            			Thread.sleep(2000);
            		...
            		//  Lines 2
            			...
            			babyfunction.inputbyxpath(ap01.Quantity1, "Entering Quantity", getData("AP-06_Line2_Match").trim());
            			Thread.sleep(2000);
            			...
            			AP05.CalculateTax("LOLUSE_WI_SPENCER");
            			...
            			Thread.sleep(3000);
            			babyfunction.jsScrollToElement("(//div[text()='Details'])[2]");
...
// AP_06 - Enter Invoice for CAPX item and 3-Way Match(Line 2)
            			...
            			babyfunction.ObjectXpathavailable(ap01.invoice_number, "Invoice NUmber", "");
            			babyfunction.clickbyxpath(ap01.invoice_number, "Clicking on Invoice number", "NIL");
            			String InvoiceNumber_1_AP06 = "1-Team1-"+babyfunction.GetRandomNumber();
            			babyfunction.inputbyxpath(ap01.invoice_number, "Entering Supplier name", InvoiceNumber_1_AP06);
            			System.out.println("Invoice Number Line 1 = "+InvoiceNumber_1_AP06);
            			Thread.sleep(2000);
...
// PO_14 - Receive Purchase Order
                        ...
                        // AP_38 - Enter Invoice for CAPX item and 3-Way Match - Total Receipt Exceed Variance
            		...
            		//  Lines 2
            			...
            			String OverBillWarning = driver.findElement(By.xpath(ap01.OverBillWaringMsg)).getText();
            			System.out.println("Warning"+OverBillWarning);
            			logger.log(LogStatus.INFO, OverBillWarning);
            			
            			babyfunction.ObjectXpathavailable(ap01.OK, "Ok", "NIL");
            			babyfunction.clickbyxpath(ap01.OK, "Ok", "NIL");
            			Thread.sleep(2000);
            			...
            			babyfunction.clickbyxpath(ap01.Quantity1, "Clicking on Quantity", "");
            			driver.findElement(By.xpath(ap01.Quantity1)).clear();
            			babyfunction.inputbyxpath(ap01.Quantity1, "Entering Quantity", getData("AP-38_Line2_Match").trim());
            			Thread.sleep(2000);
            			...
            			String SystemHoldValidation3 = driver.findElement(By.xpath(ap01.SystemHolds)).getText();
            			System.out.println("System Hold = "+SystemHoldValidation3);
            			String Validation3 = driver.findElement(By.xpath("//span[text()='Validation']//following::span[1]")).getText();
            			System.out.println("Validation Status = "+Validation3);
            			
            			if(SystemHoldValidation3.equalsIgnoreCase("0") || Validation3.equalsIgnoreCase("Validated")){
